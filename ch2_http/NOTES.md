...
10. Now inspect the contents of the second HTTP `GET` request from your browser to the server. Do you see an `“IF-MODIFIED-SINCE:”` line in the HTTP `GET`<sup>6</sup>? If so, what information follows the `IF-MODIFIED-SINCE:` header?
